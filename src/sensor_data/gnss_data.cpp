 ...
 */
#include <td_ros/sensor_data/gnss_data.hpp>
#include <iostream>
//#include "glog/logging.h"

//静态成员变量必须在类外初始化
double tdros::GNSSData::origin_longitude = 0.0;
double tdros::GNSSData::origin_latitude = 0.0;
double tdros::GNSSData::origin_altitude = 0.0;
bool tdros::GNSSData::origin_position_inited = false;
GeographicLib::LocalCartesian tdros::GNSSData::geo_converter;
...
bool GNSSData::GetOriginPosition(double& _longitude, double& _latitude, double& _altitude ){
    if(!origin_position_inited)
        return false;
    _longitude = origin_longitude;
    _latitude = origin_latitude;
    _altitude = origin_altitude;
}
